...
class StorefrontDesignSystemTest extends TestCase
{
    ...
    public function test_global_shell_exposes_accessible_navigation_and_permanent_legal_links(): void
    {
        ...
        $this->get('/')
            ...
            ->assertSee(route('pwa.manifest').'?v=5', false)
            ...
            ->assertSee(asset('favicon.ico').'?v=3', false)
            ->assertSee(asset('pwa/favicon-32x32.png').'?v=3', false)
            ->assertSee('rel="apple-touch-icon"', false)
            ->assertSee(asset('pwa/boq-apple-touch-icon-v2.png').'?v=3', false)
