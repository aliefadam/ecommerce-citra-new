...
use App\Console\Commands\ReleaseExpiredCommerceReservations;
...
Schedule::command(ReleaseExpiredCommerceReservations::class)->everyFiveMinutes()->withoutOverlapping()->onOneServer();
