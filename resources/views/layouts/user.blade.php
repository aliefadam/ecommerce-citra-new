...
<html lang="id">
    ...
    <body class="@yield('body_class', 'bg-slate-50 text-slate-800 pb-20 md:pb-0')">
        ...
        <a href="https://wa.me/628989889941" target="_blank" rel="noopener noreferrer"
            class="fixed bottom-24 right-4 md:bottom-8 md:right-6 z-40 flex items-center justify-center w-14 h-14 bg-green-500 hover:bg-green-600 active:scale-95 text-white rounded-full shadow-lg shadow-green-500/40 transition-all duration-200"
