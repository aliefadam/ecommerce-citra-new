...
<html lang="id">
    ...
    <body class="@yield('body_class', 'bg-slate-50 text-slate-800 pb-20 md:pb-0')">
        ...
        <nav class="md:hidden fixed bottom-0 inset-x-0 z-50 bg-white border-t border-slate-200">
            <div class="grid grid-cols-5">
                <a href="{{ route('frontend.index') }}"
                    ...
                    <i class="fi fi-rr-home text-[1.15rem] leading-none"></i>
                ...
                <a href="{{ route('frontend.kategori') }}"
                    ...
                    <i class="fi fi-rr-apps text-[1.15rem] leading-none"></i>
                ...
                <a href="{{ route('frontend.profil') }}"
                    class="py-2 flex flex-col items-center justify-center gap-1 text-slate-500">
                    <i class="fi fi-rr-user text-[1.15rem] leading-none"></i>
        ...
        <a href="https://wa.me/628989889941" target="_blank" rel="noopener noreferrer"
            class="fixed bottom-36 right-4 md:bottom-8 md:right-6 z-40 flex items-center justify-center w-14 h-14 bg-green-500 hover:bg-green-600 active:scale-95 text-white rounded-full shadow-lg shadow-green-500/40 transition-all duration-200"
