            ...
            <div class="help-content">
                ...
                <div class="help-faq-list" data-help-faq-list>
                    @foreach ($faqs as $index => $faq)
                        <article class="help-faq-item" data-help-faq data-category="{{ $faq['category'] }}" data-search-text="{{ Illuminate\Support\Str::lower($faq['question'].' '.$faq['answer'].' '.$categories[$faq['category']]['label']) }}">
                            <h3>
...
@section('script')
    <script>
        (() => {
            ...
            let activeCategory = new URLSearchParams(window.location.search).get('category') || 'pemesanan';
