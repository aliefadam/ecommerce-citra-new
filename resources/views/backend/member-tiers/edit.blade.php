...
@section('content')
    <main class="flex-1 p-4 sm:p-6 mt-6">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-slate-800 dark:text-white">Edit Membership Tier</h1>
            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Perbarui aturan spending untuk level member.</p>
        </div>

        <form action="{{ route('member-tiers.update', $tier) }}" method="POST"
