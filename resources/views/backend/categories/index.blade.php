...
@section('content')
    <main class="flex-1 p-4 sm:p-6 mt-6">
        <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
                <h1 class="text-2xl font-bold text-slate-800 dark:text-white">Category Management</h1>
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Kelola data kategori produk.</p>
            </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden">
            <div class="flex flex-col sm:flex-row gap-3 p-4 border-b border-slate-200 dark:border-slate-700">
                <div class="relative flex-1">
                    ...
                    <input id="categoryTableSearch" type="text" placeholder="Search category name..."
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody id="categoryTableBody" class="divide-y divide-slate-100 dark:divide-slate-700/60"></tbody>
                </table>
            </div>
            ...
            <div
                ...
                <p id="categoryPaginationInfo" class="text-sm text-slate-500 dark:text-slate-400"></p>
                <div class="flex items-center gap-1" id="categoryPaginationButtons"></div>
            </div>
        </div>
        ...
        <div id="deleteModal" class="fixed inset-0 z-50 hidden items-center justify-center p-4">
            ...
            <div
                ...
                <h3 class="font-bold text-lg text-slate-800 dark:text-white mb-2">Delete Category?</h3>
...
@section('script')
    ...
    @endphp
    <script>
        const categoryItems = @json($categoryItems);
        ...
        function sortCategoryTable(columnIndex) {
            categoryTableApi?.sortBy(columnIndex);
        }
        ...
        categoryTableApi = initAdminDataTable({
            data: categoryItems,
            perPage: 10,
            itemLabel: 'categories',
            searchInputId: 'categoryTableSearch',
