...
@section('content')
    <main class="flex-1 p-4 sm:p-6">
        <div class="mb-6">
            ...
            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Perbarui data kategori yang dipilih.</p>
        </div>
            ...
            <form action="{{ route('categories.update', $category) }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name', $category->name) }}"
                        placeholder="Contoh: Baut Stainless"
                ...
                <div class="flex gap-3 pt-2">
                    ...
                    <button type="submit"
                        class="px-4 py-2.5 text-sm font-semibold bg-blue-600 hover:bg-blue-700 text-white rounded-xl transition-colors">Update
                        Category</button>
                </div>
            </form>
        </div>
