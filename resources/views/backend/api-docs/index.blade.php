...
@section('title', 'API Katalog')

@section('content')
    <main class="flex-1 p-4 sm:p-6 mt-6">
        {{-- Header --}}
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-slate-800 dark:text-white">API Katalog</h1>
            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1 max-w-3xl">
                ...
                cukup ditentukan lewat <span class="font-mono text-xs">slug</span> di URL.
            </p>
        </div>
                ...
                <table class="w-full text-sm">
                    <thead class="bg-slate-50 dark:bg-slate-700/50">
                        <tr>
                            ...
                            <th class="px-5 py-3 text-left font-semibold text-slate-500 dark:text-slate-400">Status</th>
                        </tr>
                    </thead>
                            ...
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30">
                                ...
                                <td class="px-5 py-3.5">
                                    <span class="inline-flex rounded-full px-2.5 py-1 text-xs font-semibold {{ $company->is_active ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-500/15 dark:text-emerald-300' : 'bg-slate-100 text-slate-500 dark:bg-slate-700 dark:text-slate-400' }}">
                                        {{ $company->is_active ? 'Aktif' : 'Nonaktif (404)' }}
                                    </span>
                                </td>
                            </tr>
                        @empty
                            <tr><td colspan="4" class="px-5 py-10 text-center text-sm text-slate-400">Belum ada perusahaan.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
