...
<body>
    @php
        $trackingNumber = trim(
            (string) ($transaction->tracking_number ?: $transaction->order_id ?: $transaction->invoice_no),
        );
    ...
    <main class="label">
        ...
        <div class="row cell" style="padding:0">
            <div class="party">
                ...
                <div class="name">{{ $transaction->shipping_recipient_name ?: $transaction->user?->name ?? '-' }}
                </div>
